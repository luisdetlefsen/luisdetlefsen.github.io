...
$(document).ready(function() {
		//$.localScroll();
		$(".cache").delay(0).fadeOut(500);
		$("#wrapper-header").delay(0).animate({opacity:'1',width:'100%'},500);
		$("#wrapper-navbar").delay(0).animate({opacity:'1',height:'60px'},500);
		$("#main-container-image").delay(0).animate({opacity:'1'},500);
...
/* DISABLE HOVER EFFECT WHILE YOU SCROLL R A SMOOTHY NAVIGATION */
